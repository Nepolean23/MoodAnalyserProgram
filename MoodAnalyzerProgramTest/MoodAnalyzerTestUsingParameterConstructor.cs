...
{
    [TestClass]
    public class MoodAnalyzerTestUsingParameterConstructor
    {


        MoodAnalyzerWithParameterConstructor moodAnalyser;
        [TestMethod]
        public void Setup()
        {
            moodAnalyser = new MoodAnalyzerWithParameterConstructor();
        }
        /// <summary>
        ...
        {
            moodAnalyser = new MoodAnalyzerWithParameterConstructor("I am in Sad mood");
        ...
        {
            moodAnalyser = new MoodAnalyzerWithParameterConstructor("I am in Happy mood");
            string message = moodAnalyser.AnalyseMood();
            Assert.AreEqual("HAPPY", message);
        }
        //UC-2
        ...
        public void GivenMessage_WhenNull_USingCustomException_ShouldReturnNullMood()
        {
            ...
            catch (CustomExpectionUsingParameterConstructor exception)
            {
                Assert.AreEqual(CustomExpectionUsingParameterConstructor.ExceptionType.NULL_MOOD, exception.exceptionType);
            }
        ...
        public void GivenMessage_WhenEmpty_USingCustomException_ShouldReturnNullMood()
        {
            ...
            {
                Assert.AreEqual(CustomExpectionUsingParameterConstructor.ExceptionType.EMPTY_MOOD, exception.exceptionType);
            }
        }
