...
{
    [TestClass]
    public class MoodAnalyzerInvokeTest
    {
        InvokeMoodAnalyzer moodAnalyser;
        [TestMethod]
        public void Setup()
        {
            moodAnalyser = new InvokeMoodAnalyzer();
        }
        /// <summary>
        ...
        {
            moodAnalyser = new InvokeMoodAnalyzer("I am in Sad mood");
        ...
        {
            moodAnalyser = new InvokeMoodAnalyzer("I am in Happy mood");
            string message = moodAnalyser.AnalyseMood();
            Assert.AreEqual("HAPPY", message);
        }
        //UC-2
        ...
        public void GivenMessage_WhenNull_USingCustomException_ShouldReturnNullMood()
        {
            ...
            catch (MoodAnalyzerInvokeCustomExpection exception)
            {
                Assert.AreEqual(MoodAnalyzerInvokeCustomExpection.ExceptionType.NULL_MOOD, exception.exceptionType);
            }
        ...
        public void GivenMessage_WhenEmpty_USingCustomException_ShouldReturnNullMood()
        {
            ...
            {
                Assert.AreEqual(MoodAnalyzerInvokeCustomExpection.ExceptionType.EMPTY_MOOD, exception.exceptionType);
            }
        }
