...
{
    [TestClass]
    public class CustomMoodAnalysisExceptionTest
    {
        MoodAnalysisException moodAnalyser;
        [TestMethod]
        public void Setup()
        {
            moodAnalyser = new MoodAnalysisException();
        }
        /// <summary>
        ...
        {
            moodAnalyser = new MoodAnalysisException("I am in Sad mood");
        ...
        {
            moodAnalyser = new MoodAnalysisException("I am in Happy mood");
            string message = moodAnalyser.AnalyseMood();
            Assert.AreEqual("HAPPY", message);
        }
        //UC-2
        ...
        public void GivenMessage_WhenNull_USingCustomException_ShouldReturnNullMood()
        {
            ...
            catch (CustomMoodAnalysisException exception)
            {
                Assert.AreEqual(CustomMoodAnalysisException.ExceptionType.NULL_MOOD, exception.exceptionType);
            }
        ...
        public void GivenMessage_WhenEmpty_USingCustomException_ShouldReturnNullMood()
        {
            ...
            {
                Assert.AreEqual(CustomMoodAnalysisException.ExceptionType.EMPTY_MOOD, exception.exceptionType);
            }
        }
    }
}
