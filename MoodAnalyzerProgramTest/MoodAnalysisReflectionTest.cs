...
{
    [TestClass]
    public class MoodAnalysisReflectionTest
    {
        [TestClass]
        public class Tests
        {
            MoodAnalyzerUsingRefelction moodAnalyser;
            [TestMethod]
            public void Setup()
            {
                moodAnalyser = new MoodAnalyzerUsingRefelction();
            }
            /// <summary>
            ...
            {
                moodAnalyser = new MoodAnalyzerUsingRefelction("I am in Sad mood");
            ...
            {
                moodAnalyser = new MoodAnalyzerUsingRefelction("I am in Happy mood");
                string message = moodAnalyser.AnalyseMood();
                Assert.AreEqual("HAPPY", message);
            }
            //UC-2
            ...
            public void GivenMessage_WhenNull_USingCustomException_ShouldReturnNullMood()
            {
                ...
                catch (CustomExpectionUsingReflection exception)
                {
                    Assert.AreEqual(CustomExpectionUsingReflection.ExceptionType.NULL_MOOD, exception.exceptionType);
                }
            ...
            public void GivenMessage_WhenEmpty_USingCustomException_ShouldReturnNullMood()
            {
                ...
                {
                    Assert.AreEqual(CustomExpectionUsingReflection.ExceptionType.EMPTY_MOOD, exception.exceptionType);
                }
            }
        }
    }
